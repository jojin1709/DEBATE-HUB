...
import { appwriteClient, account } from "@/lib/appwrite/client"
    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Login to join the debate</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <Button variant="outline" className="w-full" onClick={() => handleLogin("twitter")}>
